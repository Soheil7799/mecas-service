...
def apply_gain_compression(input_file = "input.wav", output_file="output.wav", compressor_threshold_db=-1, limiter_threshold_db=0 , compressor_ratio=4 , limiter_ratio=10):
